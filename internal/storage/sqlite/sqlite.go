...
func (s *Storage) GetURL(urlAliasToGet string) (string, error) {
	...
	err = statement.QueryRow(urlAliasToGet).Scan(&resultURL)
...
// func (s *Storage) DeleteURL(urlAliasToDelete string) error {} // TODO
